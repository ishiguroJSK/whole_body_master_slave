...
pub_val_head = PoseStamped()
pub_val_rfw = WrenchStamped()
pub_val_lfw = WrenchStamped()
pub_val_list = [pub_val_com, pub_val_rf, pub_val_lf, pub_val_rh, pub_val_lh, pub_val_head, pub_val_rfw, pub_val_lfw]
...
if __name__ == '__main__':
  ...
  pub_head = rospy.Publisher('/human_tracker_head_ref', PoseStamped, queue_size=10)
  ...
  pub_list = [pub_com,pub_rf,pub_lf,pub_rh,pub_lh,pub_head,pub_rfw,pub_lfw]
